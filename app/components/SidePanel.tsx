...
export default function SidePanel() {
    ...
    return (
        <aside className="hidden lg:flex w-64 shrink-0 sticky top-0 h-screen flex-col justify-between pt-28 pb-14 px-8 border-r border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black">
